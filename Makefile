...
CPPFLAGS      = -I./ -I/usr/include/GL -I/home/malo/csc418/glui-2.36/src/include/GL 
#
# # Define location of OpenGL and GLU libraries along with their lib names
GL_LIBS       = -L/home/malo/csc418/glui-2.36/src/lib  -lGLU -lGL -lglut -lglui
...
# Define all C++ source files here
CPPSRCS       = main.cpp game.cpp color.cpp draw.cpp player.cpp enemy.cpp bullet.cpp particle.cpp vector.cpp
